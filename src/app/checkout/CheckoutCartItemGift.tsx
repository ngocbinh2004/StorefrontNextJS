...
const CheckoutCartItemGift = ({ itemCart }: { itemCart: CustomerCartItem }) => {
  //fetch qua tang kem
  ...
  if (productGiftAccessoryModel.id === 0) {
    ...
    return (
      <div className="p-3 mt-2 rounded-md bg-gray-50">
        <div className="flex items-center mb-3 text-xs font-bold text-gray-900">
...
export default CheckoutCartItemGift;
